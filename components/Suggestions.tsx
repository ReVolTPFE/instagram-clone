	...
	return (
		<div className="mt-12 ml-10">
			...
			{suggestions.map(suggestion => (
				<div key={suggestion.id} className="flex flex-col lg:flex-row items-center justify-between mt-3">
					...
					<div className="flex-1 ml-4">
						...
						<h3 className="hidden lg:block text-sm text-gray-400 truncate w-[230px]">{suggestion.jobTitle}</h3>
					</div>
